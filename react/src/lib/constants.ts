...
export const API_GOOGLE_LOGIN: string = '/api/auth/google/signin/'
export const API_GITHUB_LOGIN: string = '/api/auth/github/signin/'
...
export const ICON_APEXCHARTS: string = 'https://apexcharts.com/img/apexcharts-logo-trimmed.svg'
