...
export default function EndFooter() {
    ...
    return (
        <section className="w-full bg-text flex flex-col items-center py-10 mt-10 md:mt-20">
            <article className="w-4/5 max-w-275 flex flex-col items-center">
                <div className="w-full flex flex-row justify-between items-start">
                    <header className="flex flex-col items-center space-y-1">
                        <h4 className="flex flex-row items-center p-1 md:space-x-2">
                    ...
                    <ul className="flex flex-row items-center md:space-x-16">
                        {
                ...
                <aside className="w-full px-1 py-2 flex flex-row justify-between items-center pt-12 pb-4">
            ...
            <div className="w-4/5 max-w-280 h-[2vh] border-t border-t-background"></div>
        </section>
    )
}
