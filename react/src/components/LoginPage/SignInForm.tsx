...
export default function SignInForm({ setError, setLoader } : SignInFormProps) {
    ...
    function initGoogleTokenExchange(): GoogleCredentials | false {
        ...
        const state = params.get(GOOGLE_STATE_NAME)
    ...
    return (
        <section className="flex flex-col items-center">
            ...
            <article className="w-full flex-1 mt-4">
                <div className="flex flex-col items-center text-sm">
                    ...
                    <button
                        ...
                        <figure className="bg-white p-0.5 rounded-full">
                ...
                <div className="my-6 border-b text-center border-primary dark:border-text">
                    <span
