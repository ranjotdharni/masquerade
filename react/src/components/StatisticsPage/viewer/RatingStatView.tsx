                        ...
                        <ul className="w-full h-[85%] flex flex-col justify-evenly px-2">
                            {
                                Object.keys(question.answers!).map((a, i) => {
                                    return (
                                        <li key={`${question._id.$oid}_1x_0${i}`} className="w-full px-2 space-x-2 flex flex-row items-center">
                                            <div aria-hidden style={{backgroundColor: DIFF_COLOR_LIST[i]}} className="w-2 aspect-square rounded-xl"></div>
                                            <p style={{color: DIFF_COLOR_LIST[i]}} className="text-sm font-jbm-italic">{a}-Star Rating</p>
                                        </li>
                                    )
                                })
                            }
